...
| :--- | :--- | :--- |
| **Move Up** | `Arrow Up` / `W` / `Z` | Joystick Up |
| **Move Down** | `Arrow Down` / `S` | Joystick Down |
| **Move Left** | `Arrow Left` / `A` / `Q` | Joystick Left |
| **Move Right** | `Arrow Right` / `D` | Joystick Right |
| **Interact** | `Spacebar` | Tap on Screen / Joystick |
